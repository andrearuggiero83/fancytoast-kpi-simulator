...
coperti_totali = posti * ore_totali  # ipotesi di massima rotazione
...
# ------------------ Output ------------------
st.subheader("📋 Tabella Fasce Orarie")
st.dataframe(df[["fascia", "inizio", "fine", "durata", "atv", "peso_pct", "coperti", "ricavi"]]
             .rename(columns={
                 "fascia": "Fascia",
                 "inizio": "Ora Inizio",
                 "fine": "Ora Fine",
